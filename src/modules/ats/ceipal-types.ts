/**
 * Ceipal applicant type — shared between the legacy re-export surface in
 * `src/modules/ats/ceipal.ts` and the new `src/modules/providers/ceipal/*`
 * client so neither module has to import from the other.
 *
